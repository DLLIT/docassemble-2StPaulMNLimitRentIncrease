...
setup(name='docassemble.2StPaulMNLimitRentIncrease',
      version='0.0.1',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/2StPaulMNLimitRentIncrease/', package='docassemble.2StPaulMNLimitRentIncrease'),
     )
